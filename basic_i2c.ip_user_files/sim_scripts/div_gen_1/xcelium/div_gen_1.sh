...
#
# Script generated by Vivado on Fri Jul 19 16:49:01 -0500 2024
...
#
# Usage        : div_gen_1.sh
#                div_gen_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_gen_1.sh [-reset_run]
#                div_gen_1.sh [-reset_log]
#                div_gen_1.sh [-help]
#
...
#                script (type 'div_gen_1.sh -help' for more information).
#
...
# script info
echo -e "div_gen_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_gen_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.div_gen_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.div_gen_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log div_gen_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: div_gen_1.sh [-step]\n\
Usage: div_gen_1.sh [-lib_map_path]\n\
Usage: div_gen_1.sh [-reset_run]\n\
Usage: div_gen_1.sh [-reset_log]\n\
Usage: div_gen_1.sh [-keep_index]\n\
